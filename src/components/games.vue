      ...
      player: [
        {
          name: "black goku",
          hp: 100,
          image: [require("../assets/AnakinSkywalke.jpg")],
        },
        {
          name: "luwly",
          hp: 101,
        ...
        },
        {
          name: "goku2",
          hp: 104,
          image: [require("../assets/doramon.jpg")],
        },
      ],

      monster: [
        { name: "Thanos", hp: 101, image: [require("../assets/thanod.jpg")] },
        {
          name: "Darth ",
          hp: 102,
